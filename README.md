...
*   **templates:** HTML şablonlarının bulunduğu dizin.
    *   `base.html`: Tüm sayfalarda tutarlı bir görünüm (navbar vb.) sağlayan ve **Bootstrap 5** kullanan ana şablon.
...
*   Tweet ekleme formunun veritabanına kayıt yapmasının sağlanması.
*   Kullanıcı girişi ve kaydı (Authentication).
*   Tweet silme ve düzenleme özellikleri.
...
*   **templates:** The directory where HTML templates are located.
    *   `base.html`: The main template that provides a consistent layout (e.g., navbar) across all pages and uses **Bootstrap 5**.
...
*   Implement saving data from the add tweet form to the database.
*   User authentication (login and registration).
*   Features for deleting and editing tweets.
